...
public class CustomPermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication auth, Serializable id, String target, Object permission) {
        ...
        System.out.println(">>>>> INSIDE PERMISSION RESOLVER");
        if(Objects.equals(target, "Car")) {
            System.out.println(">>>>> Car");
            return provider.provideCarPermission(details, (Long) id);
        }
        if(Objects.equals(target, "CheckPoint")) {
            System.out.println(">>>>> CheckPoint");
            return provider.provideCheckPointPermission(details, (Long) id);
        }
        if(Objects.equals(target, "CustomerCompany")) {
            System.out.println(">>>>> CustomerCompany");
            return provider.provideCustomerCompanyPermission(details, (Long) id);
        }
        if(Objects.equals(target, "Invoice")) {
            System.out.println(">>>>> Invoice");
            return provider.provideInvoicePermission(details, (Long) id);
        }
        if(Objects.equals(target, "Product")) {
            System.out.println(">>>>> Product");
            return provider.provideProductPermission(details, (Long) id);
        }
        if(Objects.equals(target, "TruckingCompany")) {
            System.out.println(">>>>> TruckingCompany");
            return provider.provideTruckingCompanyPermission(details, (Long) id);
        }
        if(Objects.equals(target, "User")) {
            System.out.println(">>>>> User");
            return provider.provideUserPermission(details, (Long) id);
        }
        if(Objects.equals(target, "Waybill")) {
            System.out.println(">>>>> Waybill");
            return provider.provideWaybillPermission(details, (Long) id);
        }
        return false;
    }
}
